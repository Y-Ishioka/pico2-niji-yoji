...
/*------------------------------------------------------------------------*/
/* base : STM32F100: MMCv3/SDv1/SDv2 (SPI mode) control module            */
/*------------------------------------------------------------------------*/
/*
...
//extern  uint32_t  configured_freq[];
...
volatile DSTATUS Stat;	/* Physical drive status */
...
{
	//configured_freq[clk_peri] = 125*1000*1000;
